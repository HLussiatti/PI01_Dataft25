...
def developer(desarrollador: str):
    ...
    #Levanto los datos
    df_steam_games = pd.read_parquet('.\\datasets\\steam_games_dep_reducido.parquet')
...
def userdata(user_id: str):
    ...
    #Levanto los datos
    df_steam_games = pd.read_parquet('.\\datasets\\steam_games_dep_reducido.parquet')
    df_reviews = pd.read_parquet('.\\datasets\\user_reviews_NLP.parquet')
    df_user_items = pd.read_parquet('.\\datasets\\users_items_depurado.parquet')
